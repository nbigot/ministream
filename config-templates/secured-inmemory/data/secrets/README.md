...
The `data/secrets/rbac.json` file contains the list of role definition and actions allowed for each role.
...
The `data/secrets/secrets.json` file contains the list of role definition and actions allowed for each role.

**You MUST change this file!** for security reason.
...
```sh
$ go run cmd/generatepasswords/generatepasswords.go -digest sha512 -iterations 100 -password mysecretpassword
